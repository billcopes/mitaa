<?php
	...
	$title = 'MIT Alumni Association Website Guidelines &amp; Documentation';
	$credit='Presented by Moth Design';
	$description='This archive contains documentation, prototypes, and links to static designs for the MITAA website.';
?>
		...
		<section id="specs">
			...
			<ol>
				...
				<li>
					...
					<ul>
						<li class="final">
							<a href="mit-alumni-ux-FINAL.pdf">Alumni Website</a>
							<small>08.18.16 - Added Change Log, Marked as Final</small>
							<small>10.27.16 - Updated sitemap.  Updated Change Log</small>
						</li>
						<li class="final">
							<a href="alumni-directory-ux-FINAL.pdf">Alumni Directory</a>
							<small>08.18.16 - Marked as Final</small>
						</li>
						<li class="final">
							<a href="mit-alumni-account-FINAL.pdf">My Account</a>
							<small>08.18.16 - Marked as Final</small>
						</li>
					</ul>
				</li>
